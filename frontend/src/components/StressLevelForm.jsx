  ...
  return (
    <div style={styles.mainContainer}>
      ...
      <div style={styles.container}>
        <h2 style={styles.header}>Stress Level Prediction</h2>
        ...
        <div style={styles.row}>
          <div style={styles.field}><label>Blood Pressure (systolic/diastolic):</label>
            <input name="Blood Pressure" type="text" placeholder="e.g. 120/80" value={form['Blood Pressure']} onChange={handleChange} required style={styles.input} />
            {bpError && <span style={{ color: 'red', fontSize: '0.95em' }}>{bpError}</span>}
          </div>
        ...
        <button type="submit" style={styles.button}>Predict Stress Level</button>
